...
architecture behave of axil_conv2D0_BUS1_s_axi is
    ...
    constant ADDR_BIAS_DATA_0  : INTEGER := 16#0010#;
    constant ADDR_BIAS_CTRL    : INTEGER := 16#0014#;
    constant ADDR_WEIGHTS_BASE : INTEGER := 16#0020#;
    constant ADDR_WEIGHTS_HIGH : INTEGER := 16#003f#;
    constant ADDR_IMG_IN_BASE  : INTEGER := 16#1000#;
    constant ADDR_IMG_IN_HIGH  : INTEGER := 16#1fff#;
    constant ADDR_IMG_OUT_BASE : INTEGER := 16#2000#;
    constant ADDR_IMG_OUT_HIGH : INTEGER := 16#2fff#;
    ...
    signal int_img_in_address0 : UNSIGNED(9 downto 0);
    signal int_img_in_ce0      : STD_LOGIC;
    signal int_img_in_q0       : UNSIGNED(31 downto 0);
    signal int_img_in_address1 : UNSIGNED(9 downto 0);
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_weights_read = '0') and (int_img_in_read = '0') and (int_img_out_read = '0') else '0';
    RVALID    <= RVALID_t;
...
-- ----------------------- Memory logic ------------------
    ...
    -- img_in
    int_img_in_address0  <= SHIFT_RIGHT(UNSIGNED(img_in_address0), 2)(9 downto 0);
    int_img_in_ce0       <= img_in_ce0;
    img_in_q0            <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_img_in_q0, TO_INTEGER(int_img_in_shift0) * 8)(7 downto 0));
    int_img_in_address1  <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
    ...
    -- img_out
    int_img_out_address0 <= SHIFT_RIGHT(UNSIGNED(img_out_address0), 2)(9 downto 0);
    ...
    int_img_out_address1 <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
