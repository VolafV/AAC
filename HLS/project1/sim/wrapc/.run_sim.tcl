...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/archangel/Xilinx/Vitis_HLS/2021.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/archangel/Xilinx/Vitis_HLS/2021.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/archangel/Xilinx/Vitis_HLS/2021.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/archangel/Xilinx/Vitis_HLS/2021.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ::env(LD_LIBRARY_PATH) /home/archangel/Xilinx/Vitis_HLS/2021.2/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axil_conv2D0.autotvin.dat"
	set constFileTvOut       "axil_conv2D0.autotvout.dat"
	set constFileHdlTvIn     "axil_conv2D0.autohdltvin.dat"
	set constFileHdlTvOut    "axil_conv2D0.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
