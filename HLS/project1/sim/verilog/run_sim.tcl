...
if {[file isfile axil_conv2D0.autotvin.dat]} {
	file delete -force axil_conv2D0.autotvin.dat
}

if {[file isfile axil_conv2D0.autotvout.dat]} {
	file delete -force axil_conv2D0.autotvout.dat
}
