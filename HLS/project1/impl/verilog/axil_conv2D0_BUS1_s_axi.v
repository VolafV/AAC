...
#(parameter
    ...
    input  wire [3:0]                    img_out_address0,
    ...
    input  wire [5:0]                    img_in_address0,
...
localparam
    ...
    ADDR_IER          = 7'h08,
    ADDR_ISR          = 7'h0c,
    ADDR_BIAS_DATA_0  = 7'h30,
    ADDR_BIAS_CTRL    = 7'h34,
    ADDR_IMG_OUT_BASE = 7'h10,
    ADDR_IMG_OUT_HIGH = 7'h1f,
    ADDR_WEIGHTS_BASE = 7'h20,
    ADDR_WEIGHTS_HIGH = 7'h2f,
    ADDR_IMG_IN_BASE  = 7'h40,
    ADDR_IMG_IN_HIGH  = 7'h7f,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
//------------------------Local signal-------------------
    ...
    wire [3:0]                    int_img_in_address0;
    wire                          int_img_in_ce0;
    wire [31:0]                   int_img_in_q0;
    wire [3:0]                    int_img_in_address1;
    wire                          int_img_in_ce1;
    wire                          int_img_in_we1;
...
assign RVALID  = (rstate == RDDATA) & !int_img_out_read & !int_weights_read & !int_img_in_read;
...
assign int_img_out_address1 = ar_hs? raddr[3:2] : waddr[3:2];
...
assign int_img_in_address1  = ar_hs? raddr[5:2] : waddr[5:2];
