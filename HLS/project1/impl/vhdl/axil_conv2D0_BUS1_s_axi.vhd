...
entity axil_conv2D0_BUS1_s_axi is
generic (
...
port (
    ...
    img_out_address0      :in   STD_LOGIC_VECTOR(3 downto 0);
    ...
    img_in_address0       :in   STD_LOGIC_VECTOR(5 downto 0);
...
end entity axil_conv2D0_BUS1_s_axi;
...
architecture behave of axil_conv2D0_BUS1_s_axi is
    ...
    constant ADDR_BIAS_DATA_0  : INTEGER := 16#30#;
    constant ADDR_BIAS_CTRL    : INTEGER := 16#34#;
    constant ADDR_IMG_OUT_BASE : INTEGER := 16#10#;
    constant ADDR_IMG_OUT_HIGH : INTEGER := 16#1f#;
    constant ADDR_WEIGHTS_BASE : INTEGER := 16#20#;
    constant ADDR_WEIGHTS_HIGH : INTEGER := 16#2f#;
    constant ADDR_IMG_IN_BASE  : INTEGER := 16#40#;
    constant ADDR_IMG_IN_HIGH  : INTEGER := 16#7f#;
    ...
    -- memory signals
    signal int_img_out_address0 : UNSIGNED(1 downto 0);
    signal int_img_out_ce0     : STD_LOGIC;
    signal int_img_out_be0     : UNSIGNED(3 downto 0);
    signal int_img_out_d0      : UNSIGNED(31 downto 0);
    signal int_img_out_address1 : UNSIGNED(1 downto 0);
    signal int_img_out_ce1     : STD_LOGIC;
    signal int_img_out_q1      : UNSIGNED(31 downto 0);
    signal int_img_out_read    : STD_LOGIC;
    signal int_img_out_write   : STD_LOGIC;
    signal int_img_out_shift0  : UNSIGNED(1 downto 0);
    ...
    signal int_img_in_address0 : UNSIGNED(3 downto 0);
    signal int_img_in_ce0      : STD_LOGIC;
    signal int_img_in_q0       : UNSIGNED(31 downto 0);
    signal int_img_in_address1 : UNSIGNED(3 downto 0);
    ...
    signal int_img_in_shift0   : UNSIGNED(1 downto 0);

    component axil_conv2D0_BUS1_s_axi_ram is
        generic (
    ...
    end component axil_conv2D0_BUS1_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_img_out
int_img_out : axil_conv2D0_BUS1_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "S2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_img_out_q1);
-- int_weights
int_weights : axil_conv2D0_BUS1_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_weights_q1);
-- int_img_in
int_img_in : axil_conv2D0_BUS1_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_img_out_read = '0') and (int_weights_read = '0') and (int_img_in_read = '0') else '0';
    RVALID    <= RVALID_t;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                ...
                elsif (int_img_out_read = '1') then
                    rdata_data <= int_img_out_q1;
...
-- ----------------------- Memory logic ------------------
    -- img_out
    int_img_out_address0 <= SHIFT_RIGHT(UNSIGNED(img_out_address0), 2)(1 downto 0);
    int_img_out_ce0      <= img_out_ce0;
    int_img_out_be0      <= SHIFT_LEFT(TO_UNSIGNED(1, 4), TO_INTEGER(UNSIGNED(img_out_address0(1 downto 0)))) when img_out_we0 = '1' else (others=>'0');
    int_img_out_d0       <= UNSIGNED(img_out_d0) & UNSIGNED(img_out_d0) & UNSIGNED(img_out_d0) & UNSIGNED(img_out_d0);
    int_img_out_address1 <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    int_img_out_ce1      <= '1' when ar_hs = '1' or (int_img_out_write = '1' and WVALID  = '1') else '0';
    -- weights
    ...
    -- img_in
    int_img_in_address0  <= SHIFT_RIGHT(UNSIGNED(img_in_address0), 2)(3 downto 0);
    int_img_in_ce0       <= img_in_ce0;
    img_in_q0            <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_img_in_q0, TO_INTEGER(int_img_in_shift0) * 8)(7 downto 0));
    int_img_in_address1  <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_img_in_be1       <= UNSIGNED(WSTRB) when int_img_in_we1 = '1' else (others=>'0');
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (ar_hs = '1' and raddr >= ADDR_IMG_OUT_BASE and raddr <= ADDR_IMG_OUT_HIGH) then
                    int_img_out_read <= '1';
                else
                    int_img_out_read <= '0';
                end if;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_img_out_shift0 <= (others=>'0');
            elsif (ACLK_EN = '1') then
                if (img_out_ce0 = '1') then
                    int_img_out_shift0 <= UNSIGNED(img_out_address0(1 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_img_in_shift0 <= (others=>'0');
            elsif (ACLK_EN = '1') then
                if (img_in_ce0 = '1') then
                    int_img_in_shift0 <= UNSIGNED(img_in_address0(1 downto 0));
                end if;
            end if;
        end if;
    end process;
...
entity axil_conv2D0_BUS1_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity axil_conv2D0_BUS1_s_axi_ram;

architecture behave of axil_conv2D0_BUS1_s_axi_ram is
